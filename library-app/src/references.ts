...
const siteSeeds: Seed[] = [
  ...
  },
  {
    ...
    quality: { tier: 'canonical', width: 1251, height: 713, confidence: 1, reliableFor: ['layout', 'typography', 'palette', 'engraving treatment'], note: 'Current live browser capture with the browser scrollbar removed.' },
  ...
  },
  {
    ...
    primaryCategory: 'Illustrated Storybook', tags: ['interactive gate', 'pink field', 'bold condensed type', 'ball physics', 'single instruction'],
    ...
    quality: { tier: 'canonical', width: 1279, height: 720, confidence: 1, reliableFor: ['interaction concept', 'type scale', 'palette'], note: 'Current entrance-state capture.' },
  ...
  },
  {
    ...
    primaryCategory: 'Vast Quiet Cinematic', tags: ['documentary portrait', 'split screen', 'industrial story', 'black panel', 'spaced type'],
    ...
    quality: { tier: 'canonical', width: 1279, height: 720, confidence: 1, reliableFor: ['split composition', 'portrait crop', 'typography', 'tone'], note: 'Current entrance-state capture.' },
  ...
  },
  {
    ...
    quality: { tier: 'canonical', width: 1256, height: 716, confidence: 1, reliableFor: ['product hierarchy', 'copy density', 'proof placement'], note: 'Current live capture with the browser scrollbar removed.' },
  ...
  },
  {
    ...
    quality: { tier: 'canonical', width: 1279, height: 720, confidence: 1, reliableFor: ['film treatment', 'overlay hierarchy', 'motion direction'], note: 'Current live capture plus a locally stored source video asset.' },
