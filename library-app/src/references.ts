...
const siteSeeds: Seed[] = [
  ...
  },
  {
    ...
    primaryCategory: 'Data-as-Texture', tags: ['AI product', 'evidence UI', 'plainspoken copy', 'white canvas', 'compact proof'],
    source: { kind: 'website', siteName: 'Oqoqo', url: 'https://oqoqo.ai/', captureMethod: 'live-browser-capture', capturedAt: '2026-08-23', sourceGroupId: 'oqoqo', originalAsset: '/assets/site-captures/17-oqoqo.png' },
    ...
    quality: { tier: 'canonical', width: 1600, height: 1000, confidence: 1, reliableFor: ['product hierarchy', 'copy density', 'proof placement', 'interface framing'], note: 'High-resolution unobstructed live capture after declining the optional analytics dialog.' },
