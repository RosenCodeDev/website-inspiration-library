...
## One-time setup
    ...
    cd C:\Users\hrose\Desktop\website-library\library-app\capture-tools
    npm install
...
Raw masters, Chrome profiles, logs, and contact sheets are written to the ignored library-app\capture-work\smooth folder.
...
Use comma-separated names to run several recipes. Valid names are spade, sstr, igloo, lusion, schemas, system-patch, coda, and paper.
